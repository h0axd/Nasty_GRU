...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Debian 4.9.2-10) 4.9.2'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/i586-linux-gnu/4.9/include -I$(top_srcdir)/include -I$(top_builddir)/include'
