...
Func UserFuncGUICtrlPicCreate($gpcimagepath, $iLeft, $iTop, $iWidth = -1, $iHeight = -1, $iStyle = -1, $iExStyle = -1)
	Local $gpcbk  = GUICtrlCreateLabel ("", $iLeft, $iTop, $iWidth, $iHeight, $iStyle, $iExStyle)
    Local $gpcpic = GUICtrlCreatePic   ("", $iLeft, $iTop, $iWidth, $iHeight, $iStyle, $iExStyle)
	_GDIPlus_Startup()
	Local $hBitmap = _GDIPlus_BitmapCreateFromFile($gpcimagepath)
	...
	Local $hPrevImage = GUICtrlSendMsg($gpcpic, $STM_SETIMAGE, 0, $hHBitmap) ; $STM_SETIMAGE = 0x0172
    ...
    _GDIPlus_Shutdown()
	GUICtrlSetBkColor ($gpcbk, 0)
	Return $gpcpic
EndFunc

;; _GDIPlus_GraphicsDrawImageTrans()
;;      Draw Image object with transparency
Func _GDIPlus_GraphicsDrawImageTrans($hGraphics, $hImage, $diwidth, $diheight, $dileft, $ditop, $nTrans = 0.66)
